  ...
  return (
    <div className="flex flex-col gap-6">
      <section className="flex flex-col items-center justify-center h-full container gap-6 pt-10 md:pt-24 lg:pt-36">
        ...
        Join us in our mission to create a more knowledgeable workforce. Explore our diverse range of courses, track your progress, and provide feedback to shape the future of our learning resources. Together, we can cultivate a thriving learning environment!
        </p>
